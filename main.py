...
GUILD_ID = 1497059005431021750  # Guild ID where command registers
# Add as many staff role IDs as you want here:
STAFF_ROLE_IDS = [1497062198759915661, 1497062199892377670, 1501664687316664340, 1497062200723112056]  # example: [role_id1, role_id2, ...]
